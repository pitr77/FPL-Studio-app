                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 cursor-pointer group select-none" onClick={() => setShowInfo(!showInfo)}>
                            <p className="text-slate-400 text-sm">
                                Transfer Index combines <strong>Form (50%)</strong> and our <strong>Dynamic FDR (50%)</strong>, using the same model as the Fixtures & FDR Planner. Blank Gameweeks count as even worse than a Very Hard fixture and are penalised as 6 in the DIFF Score.
                            </p>
                                ...
                                <ul className="space-y-1.5 text-xs">
                                    ...
                                    <li className="flex flex-col gap-1">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-slate-400">Sum for next 5 games.</span>
                                        </div>
                                        <div className="text-[10px] text-purple-400 italic">
                                            * Blank Gameweeks count as 6 points (worse than Very Hard).
                                        </div>
                                    </li>
                                </ul>
                            </div>
